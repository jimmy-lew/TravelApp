...
//
//public class BusTimingCardFavouriteAdapter extends RecyclerView.Adapter<BusTimingCardViewHolder> {
//
//    private RecyclerView.RecycledViewPool viewPool = new RecyclerView.RecycledViewPool();
//    private ArrayList<String> favouritesList;
//
//    public BusTimingCardFavouriteAdapter(ArrayList<String> favouritesList){
