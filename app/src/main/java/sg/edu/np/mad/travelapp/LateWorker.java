...
public class LateWorker extends Worker {

    public LateWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
        super(context, workerParams);
    }

    private static final String TAG = LateWorker.class.getName();
    ...
    public Result doWork() {
        ...
        try {
            ...
            LateNotification.sendNotification(context);
